...
public:
	...
	// List of lists of static objects different levels of details.
	vector< vector< ObjRef<Basic3D> > > o3dlist;

	// Sky box
	vector< ObjRef<Basic3D> > sky;
	...
	// View matrix for sky box.
	Matrix4fx view_sky_mx;
